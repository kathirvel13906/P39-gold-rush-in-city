...
function preload(){
  ...
  jungleImage = loadImage("cityImage.png");
}
...
function setup() {
  ...
  jungle = createSprite(displayWidth,displayHeight-900,2700,10);
  ...
  monkey.addAnimation("monkeyRun", man);
  monkey.scale = 0.14;
  //monkey.debug = true;
...
function obstacles() {
  if(frameCount %160 === 0) {
    ...
    obstacle.scale = 0.4;
    obstacle.setCollider("rectangle",0,0,140,140);
    //obstacle.debug = true;
